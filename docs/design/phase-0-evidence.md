...
> CI verified on GitHub 2026-09-14: run 34893509998 failed in `android-actions/setup-android@v3` (its default package list includes the removed `tools` package); fixed in 10984ee (`packages: platform-tools`); run 34893632165 on 10984ee passed every step (`:core:test :app:testDebugUnitTest :app:assembleDebug`).
