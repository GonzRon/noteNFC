...
/** A template's own row, before [com.loosecannon.servicetag.core.usecase.ApplyTemplate] mints an id for it. */
 ...
 * sees. Starter data only — no code past [com.loosecannon.servicetag.core.usecase.ApplyTemplate] may
